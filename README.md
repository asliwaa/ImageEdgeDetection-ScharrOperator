...
1.  **EdgeDetectionApp** (C# / WPF)
    ...
    * Handles image loading, result display, and execution time benchmarking.
...
2.  **EdgeDetectionCPP** (C++ DLL)
    ...
    * Implementation based on loops and pointer arithmetic.
...
* **Benchmark:** Automatic measurement of algorithm execution time (in milliseconds) for the selected method.
* **Live Preview:** Side-by-side display of the original image and the processed result.

## 🛠️ Requirements

* **Operating System:** Windows 64-bit.
* **Environment:** Visual Studio 2022 (or newer).
* **Frameworks:**
...
4.  Run the `EdgeDetectionApp` project.
